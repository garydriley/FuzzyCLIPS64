...
struct factgenData
  {
   ...
   struct entityRecord   FactPNFuzzyValue;
  };
...
void InitializeFactReteFunctions(
  Environment *theEnv)
  {
   ...
   struct entityRecord   factPNFuzzyValue = {   "FACT_PN_FUZZY_VALUE",
                                                       SCALL_PN_FUZZY_VALUE,0,0,1,
                                                       PrintPNFUZZY_VALUE,
                                                       PrintPNFUZZY_VALUE,NULL,
                                                       FactFuzzyValuePNFunction,
                                                       NULL,NULL,NULL,NULL,NULL,NULL, NULL,NULL };
#endif
...
#if FUZZY_DEFTEMPLATES
   memcpy(&FactgenData(theEnv)->FactPNFuzzyValue,&factPNFuzzyValue,sizeof(struct entityRecord));
#endif
...
#if FUZZY_DEFTEMPLATES
   InstallPrimitive(theEnv,&FactgenData(theEnv)->FactPNFuzzyValue,SCALL_PN_FUZZY_VALUE);
#endif
#endif
  }
