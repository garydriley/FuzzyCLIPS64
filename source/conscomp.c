...
/*      V: FuzzyValue Hash Nodes              */
/*      W: FuzzyValues                        */
/*      X: FuzzyValue x,y arrays (fuzzy set)  */
/*#endif                                      */
/**********************************************/

#if FUZZY_DEFTEMPLATES
#define PRIMARY_CODES   "ADGHJKMNOQRTUYZ"
#define PRIMARY_LEN     15
#else
...
#if FUZZY_DEFTEMPLATES
   fprintf(ConstructCompilerData(theEnv)->HeaderFP,"#include \"fuzzylv.h\"\n");
   fprintf(ConstructCompilerData(theEnv)->HeaderFP,"#include \"fuzzyval.h\"\n");
#endif
...
#if FUZZY_DEFTEMPLATES
   fprintf(fp,"   SetFuzzyValueTable(theEnv,fvht%d);\n",ConstructCompilerData(theEnv)->ImageID);
#endif
      ...
      switch (exprPtr->type)
        {
         ...
         case FUZZY_VALUE_TYPE:
           PrintFuzzyValueReference(theEnv,ConstructCompilerData(theEnv)->ExpressionFP,(CLIPSFuzzyValue *) exprPtr->value);
           break;
#endif
...
#if FUZZY_DEFTEMPLATES
      /* ================================================
             NOTE: above comment is not correct -- actually 44
                       and with fuzzy template is only 41.
                           Should not even consider this comment to be
                           correct -- real value is PRIMARY_LEN +
                           SECONDARY_LEN
                           Then extended SECONDARY LIST with lower case
                           letters ... should not cause problems for
                           any real C compiler --- now at 51
         ================================================ */
#endif
