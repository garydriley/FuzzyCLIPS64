...
#define CREATION_DATE_STRING "2/9/18"
#endif

#ifndef BANNER_STRING
#define BANNER_STRING "         FuzzyCLIPS (Cypher Beta 3/1/18)\n"
#endif
...
/* FUZZY extensions */
#define FUZZY_VALUE_TYPE_NAME          "FUZZY-VALUE"
...
#define SINGLEFIELD_BITS (NUMBER_BITS | LEXEME_BITS | ADDRESS_BITS | INSTANCE_NAME_BIT | FUZZY_BIT)
...
/******************************************************/
/* NOTE: Below FUZZY_VALUE is set to 9 -- a           */
/*       primitive as well                            */
/******************************************************/
#define FUZZY_VALUE_TYPE                9   /* 1st number after original primitives */
