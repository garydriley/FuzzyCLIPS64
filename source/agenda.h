...
#if CERTAINTY_FACTORS 
   SalienceEvaluationType CFEvaluation;
#endif
  };
...
#endif
#if CERTAINTY_FACTORS   
   SalienceEvaluationType  GetCFEvaluation(Environment *);
   SalienceEvaluationType  SetCFEvaluation(Environment *,SalienceEvaluationType);
   void                    SetCFEvaluationCommand(Environment *,UDFContext *,UDFValue *);
   void                    GetCFEvaluationCommand(Environment *,UDFContext *,UDFValue *);
#endif
